 ...
 * @version 1.0 
 */
package vrptw.spea.baseS;

import java.io.Serializable;

import vrptw.spea.baseS.Configuration.* ;
import vrptw.spea.base.variable.Binary;
import vrptw.spea.base.variable.BinaryReal;
import vrptw.spea.base.variable.Int;
import vrptw.spea.base.variable.Permutation;
import vrptw.spea.base.variable.Real;
      ...
      for (int var = 0; var < problem_.getNumberOfVariables(); var++) {
        if (problem.getPrecision() == null) {
          ...
          for (int i = 0; i < problem.getNumberOfVariables(); i++)
            precision[i] = vrptw.spea.baseS.Configuration.DEFAULT_PRECISION ;
