...
/**
 * This class implements the spread metric. It can be used also as command
...
public class Spread {
  ...
  static vrptw.spea.metricas.MetricsUtil utils_;//utils_ is used to access to 
  ...
  public double spread(double [][] front, 
    ...
    Arrays.sort(normalizedFront,
    		    new vrptw.spea.metricas.LexicoGraphicalComparator());
