...
public class GeneralizedSpread {
  ...
  static vrptw.spea.metricas.MetricsUtil utils_;  // MetricsUtil provides some 
  ...
  public GeneralizedSpread() {
    utils_ = new vrptw.spea.metricas.MetricsUtil();
  } // GeneralizedSpread
  ...
  public double generalizedSpread(double [][] paretoFront,
    ...
    for (int i = 0; i < numberOfObjectives; i++) {
      Arrays.sort(normalizedParetoFront,new vrptw.spea.metricas.ValueComparator(i));
    ...
    Arrays.sort(normalizedFront,new vrptw.spea.metricas.LexicoGraphicalComparator());
